...
return function(mod)
  ...
  mod.content.pokemon:patch("BULBASAUR", {dexEntry = { kind = "SELMILLA" }})
  mod.content.pokemon:patch("IVYSAUR", {dexEntry = { kind = "SELMILLA" }})
  mod.content.pokemon:patch("VENUSAUR", {dexEntry = { kind = "SELMILLA" }})
  ...
  mod.content.pokemon:patch("DEWONG", {dexEntry = { kind = "LEÓN MARINO" }})
  ...
  mod.content.pokemon:patch("CLOYSETR", {dexEntry = { kind = "BIVALVO" }})
  mod.content.pokemon:patch("GHASTLY", {dexEntry = { kind = "GAS" }})
